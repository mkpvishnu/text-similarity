...
class Metrics:
    ...
    def detect_temporal_shift(self, text1: str, text2: str, print_info: bool = False, parse_dependence: bool = False, sentence_model: Optional[str] = None) -> float:
        return detect_temporal_shift(self.analyzer, text1, text2, print_info, parse_dependence, sentence_model)
